<%-- 
    Document   : Empleado
    Created on : 3/05/2024, 11:11:39 p. m.
    Author     : jodon
--%>
                ...
                <div class="card-body">
                    <form action="Controller?menu=Empleado" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="${porAcutalizar.getTel()}" name="txtTel" class="form control">
                        </div>
                        <div class="form-group">
                            <label>Estado</label>
                        ...
                        <div class="form-group">
                            <label>Usuario</label>
                            <input type="text" value="${porAcutalizar.getUser()}" name="txtUser" class="form control">
                        </div>
                    ...
                    <tbody>
                        <c:forEach var="em" items="${empleados}">
                            <tr>
                                ...
                                <td>${em.getUser()}</td>
                                <td>
                                    <a class="btn btn-warning" href="Controller?menu=Empleado&accion=Editar&id=${em.getId()}">Editar</a>
                                    <a class="btn btn-danger" href="Controller?menu=Empleado&accion=Delete&id=${em.getId()}">Eliminar</a>
                                </td>
                            </tr>
                        </c:forEach>
